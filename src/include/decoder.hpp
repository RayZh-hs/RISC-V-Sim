    ...
    struct InstructionHeader {
        ...
        static InstructionHeader from(uint32_t instruction) {
            return InstructionHeader{
                .op_code = static_cast<uint8_t>(instruction & 0b1111111),
        ...
        void decode() {
            switch (op_code) {
                case 0b0110111: ins_type = LUI; break;
                case 0b0010111: ins_type = AUIPC; break;
                case 0b1101111: ins_type = JAL; break;
                case 0b1100111: ins_type = JALR; break;
                case 0b1100011:
                    switch (func3) {
                        case 0b000: ins_type = BEQ; break;
                        case 0b001: ins_type = BNE; break;
                        case 0b100: ins_type = BLT; break;
                        case 0b101: ins_type = BGE; break;
                        case 0b110: ins_type = BLTU; break;
                        case 0b111: ins_type = BGEU; break;
                        default: throw std::runtime_error("Invalid B-Type func3");
                    }
                    break;
                case 0b0000011:
                    switch (func3) {
                        case 0b000: ins_type = LB; break;
                        case 0b001: ins_type = LH; break;
                        case 0b010: ins_type = LW; break;
                        case 0b100: ins_type = LBU; break;
                        case 0b101: ins_type = LHU; break;
                        default: throw std::runtime_error("Invalid Load-Type func3");
                    }
                    break;
                case 0b0100011:
                    switch (func3) {
                        case 0b000: ins_type = SB; break;
                        case 0b001: ins_type = SH; break;
                        case 0b010: ins_type = SW; break;
                        default: throw std::runtime_error("Invalid S-Type func3");
                    }
                    break;
                case 0b0010011:
                    switch (func3) {
                        case 0b000: ins_type = ADDI; break;
                        case 0b001: ins_type = SLLI; break;
                        case 0b010: ins_type = SLTI; break;
                        case 0b011: ins_type = SLTIU; break;
                        case 0b100: ins_type = XORI; break;
                        case 0b101: // SRLI or SRAI
                            if (func7 == 0b0000000) ins_type = SRLI;
                            else if (func7 == 0b0100000) ins_type = SRAI;
                            else throw std::runtime_error("Invalid I-Type func7 for func3=101");
                            break;
                        case 0b110: ins_type = ORI; break;
                        case 0b111: ins_type = ANDI; break;
                        default: throw std::runtime_error("Invalid I-Type func3");
                    }
                    break;
                case 0b0110011:
                    switch (func3) {
                        case 0b000: // ADD or SUB, strange to be distinguished by func7
                            if (func7 == 0b0000000) ins_type = ADD;
                            else if (func7 == 0b0100000) ins_type = SUB;
                            else throw std::runtime_error("Invalid R-Type func7 for func3=000");
                            break;
                        case 0b001: ins_type = SLL; break;
                        case 0b010: ins_type = SLT; break;
                        case 0b011: ins_type = SLTU; break;
                        case 0b100: ins_type = XOR; break;
                        case 0b101: // SRL or SRA
                            if (func7 == 0b0000000) ins_type = SRL;
                            else if (func7 == 0b0100000) ins_type = SRA;
                            else throw std::runtime_error("Invalid R-Type func7 for func3=101");
                            break;
                        case 0b110: ins_type = OR; break;
                        case 0b111: ins_type = AND; break;
                        default: throw std::runtime_error("Invalid R-Type func3");
                    }
                    break;
                default:
